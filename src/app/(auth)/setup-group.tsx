...
export default function SetupGroupScreen() {
  ...
  const defaultTasks = [
    { title: 'Clean fridge', complexity: 40, type: 'weekly', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [6] },
    { title: 'Clean microwave', complexity: 15, type: 'weekly', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [6] },
    { title: 'Clean stove top', complexity: 20, type: 'weekly', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [6] },
    { title: 'Clear the table', complexity: 5, type: 'daily', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [] },
    { title: 'Make breakfast', complexity: 15, type: 'daily', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [] },
    { title: 'Make dinner', complexity: 30, type: 'daily', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [] },
    { title: 'Make lunch', complexity: 30, type: 'daily', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [] },
    { title: 'Set the table', complexity: 5, type: 'daily', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [] },
    { title: 'Wash dishes', complexity: 15, type: 'daily', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [] },
    { title: 'Dust rooms', complexity: 30, type: 'weekly', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [6] },
    { title: 'Vacuum rooms', complexity: 10, type: 'weekly', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [6] },
    { title: 'Change bed sheets', complexity: 25, type: 'weekly', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [0] },
    { title: 'Make double bed', complexity: 5, type: 'daily', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [] },
    { title: 'Make single bed', complexity: 5, type: 'daily', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [] },
    { title: 'Clean mirrors', complexity: 30, type: 'weekly', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [6] },
    { title: 'Clean bathroom sink', complexity: 10, type: 'weekly', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [6] },
    { title: 'Clean shower', complexity: 30, type: 'weekly', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [6] },
    { title: 'Clean toilet', complexity: 25, type: 'weekly', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [6] },
    { title: 'Mop floor', complexity: 50, type: 'weekly', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [0] },
    { title: 'Do laundry', complexity: 10, type: 'weekly', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [0] },
    { title: 'Hang the laundry', complexity: 15, type: 'weekly', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [0] },
    { title: 'Clean trash cans', complexity: 25, type: 'weekly', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [6] },
    { title: 'Take out trash', complexity: 15, type: 'daily', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [] },
    { title: 'Grocery shopping', complexity: 40, type: 'weekly', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [6] },
    { title: 'Put groceries away', complexity: 15, type: 'weekly', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [6] },
    { title: 'Clean patio', complexity: 35, type: 'weekly', availableFor: ['Adult', 'Teen', 'Child'], weekDays: [0] },
  ];
